                    ...
                    <table id="patientsTable" class="table table-bordered table-hover table-masterlist text-center w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary btn-sm rounded-circle edit-patient" 
                                    ...
                                    <form action="{{ route('animal-bite.patients.destroy', $patient->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm rounded-circle" onclick="return confirm('Are you sure you want to delete this patient?')">
...
<script>
    $(document).ready(function() {
        ...
        $('.edit-patient').on('click', function() {
            ...
            $('#editPatientForm').attr('action', `/animal-bite/patients/${id}`);
        });
    });
</script>
@endpush
