<div class="modern-nav-section">
    <ul class="modern-nav-menu">
        ...
        <li class="{{ request()->routeIs('animal-bite.weekly-patient') ? 'active' : '' }}">
            <a href="{{ route('animal-bite.weekly-patient') }}" class="modern-nav-link">
                <div class="modern-nav-icon">
                    <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                        <line x1="16" y1="2" x2="16" y2="6"></line>
                ...
                <span class="modern-nav-text">Weekly Patient</span>
            </a>
        </li>
        @endif
